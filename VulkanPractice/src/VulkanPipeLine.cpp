...
std::vector<char> VulkanRenderer::VulkanPipeline::ReadFile(const std::string& filename)
{
...
VkShaderModule VulkanRenderer::VulkanPipeline::CreateShaderModule(VkDevice& device, const std::vector<char>& code)
{
