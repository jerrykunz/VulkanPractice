...
namespace VulkanRenderer
{
    ...
    void VulkanVertexBuffer::LoadVertices(Vertex* vertices, size_t verticeCount, VkPhysicalDevice& physicalDevice, VkDevice& device, VkQueue& graphicsQueue, VkCommandPool& commandPool)
    {
